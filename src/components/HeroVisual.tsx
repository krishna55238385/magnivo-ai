...
function PipelineStrip() {
  ...
  return (
    ...
    >
      <div
        className="flex items-center gap-1.5 text-[9px] font-bold tracking-widest uppercase shrink-0 mr-1"
        ...
        <div key={s.label} className="flex items-center gap-2 min-w-0">
          ...
          >
            ...
            <span
              ...
              style={{ color: i >= stages.length - 1 ? accent : accent2 }}
            >
              {s.count}
            </span>
          </div>
...
function InsightsStrip() {
  const items = [
    {
      label: "3 anomalies flagged",
      tone: "rgba(27,58,45,0.10)",
      color: "var(--accent-blue)",
      icon: Bell,
    },
    {
      label: "2 guardrails active",
      tone: "rgba(196,146,42,0.18)",
  ...
  return (
    <div
      className="flex flex-wrap items-center gap-2 rounded-xl px-2.5 py-2 pointer-events-none"
      style={subtleCard}
    >
  ...
  return (
    <div className="rounded-xl p-3 flex flex-col min-h-0 pointer-events-none" style={cardStyle}>
      <div className="flex items-start justify-between gap-2 mb-3">
        ...
        <div className="flex gap-1.5 shrink-0">
          <span
            ...
            style={{ background: "rgba(27,58,45,0.10)", color: accent }}
          >
            Filter
          </span>
          <span
            className="hidden sm:inline text-[9px] font-bold px-2 py-0.5 rounded-md"
            style={{ background: "rgba(26,26,26,0.03)", color: inkMuted }}
          >
            Export
          </span>
        </div>
      ...
      <div
        ...
        style={{ borderColor: "rgba(26,26,26,0.08)", color: inkMuted }}
      >
...
const liveLogs = [
  {
    ...
    action: "Drafted hyper-personalised email to VP Sales at Stripe",
    time: "Just now",
  },
  {
    agent: "Leadfinder-Omega",
    action: "Identified 43 new high-intent accounts in fintech",
    time: "1m ago",
  },
  {
    agent: "Orbit-Sync",
    action: "Updated CRM records for 12 closed-won opportunities",
    time: "3m ago",
  },
  {
    agent: "Reachout-Beta",
    action: "Followed up with 14 dormant leads, 2 meetings booked",
    time: "8m ago",
  },
  {
    agent: "Compass-Prime",
    action: "Reranked 112 accounts by composite intent + fit score",
    time: "12m ago",
  },
];
      ...
      <div className="rounded-xl p-4 relative overflow-hidden" style={subtleCard}>
        ...
        <div className="space-y-2 max-h-[140px] overflow-hidden relative">
          <div
            ...
            style={{
              background: "linear-gradient(to top, rgba(245,242,236,1), rgba(245,242,236,0))",
            }}
          />
          {liveLogs.map((log, i) => (
            <div
              key={i}
              className="flex gap-2 sm:gap-3 text-[10px] font-mono items-start"
      ...
      >
        ...
        <div className="p-3 sm:p-3.5 md:p-4 relative">
          ...
          >
            ...
            <span
              className="h-2.5 w-2.5 rounded-full"
              style={{ background: "color-mix(in oklab, var(--accent-green) 75%, #fff)" }}
            />
            <span
              className="h-2.5 w-2.5 rounded-full"
              style={{ background: "color-mix(in oklab, var(--accent-blue) 78%, #fff)" }}
            />
            <div className="ml-1 sm:ml-4 min-w-0 flex-1 truncate text-[10px] sm:text-xs font-medium font-mono">
          ...
          <div className="grid grid-cols-12 gap-2.5 sm:gap-3.5">
            {/* Sidebar */}
            <div
              className="col-span-3 hidden sm:flex flex-col gap-1.5"
              style={{ borderRight: "1px solid rgba(26,26,26,0.10)", paddingRight: 10 }}
            >
              {[
            ...
            <div className="col-span-12 sm:col-span-9 flex flex-col gap-2.5 sm:gap-3.5">
              ...
              <div
                className="md:hidden rounded-xl px-3 py-2 pointer-events-none"
                style={subtleCard}
              >
                <div
                ...
                >
                  <span className="inline-flex items-center gap-1">
                    <span className="h-1 w-1 rounded-full" style={{ background: accent }} /> Agents:
                    24/24
                  </span>
                  <span className="inline-flex items-center gap-1">
                    <span className="h-1 w-1 rounded-full" style={{ background: accent2 }} />{" "}
                    Forecast: 94%
                  </span>
                  <span className="inline-flex items-center gap-1">
                    <span className="h-1 w-1 rounded-full" style={{ background: accent }} /> Queue:
                    4
                  </span>
                </div>
              </div>
