...
function PlatformPage() {
  ...
  return (
    <SiteLayout>
      ...
      <div
        className={`hidden lg:flex fixed bottom-8 right-8 z-50 transition-all duration-300 ${showFloat ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}
      >
        <button
          onClick={open}
          className="flex items-center gap-2.5 px-5 py-3 rounded-full bg-[var(--accent-blue)] text-white text-sm font-semibold hover:brightness-110 transition-all"
        >
...
function HeroSection({ onAudit }: { onAudit: () => void }) {
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      <div
        className="absolute -top-40 -left-20 w-[700px] h-[600px] rounded-full opacity-[0.12] blur-[120px] pointer-events-none"
        style={{ background: "radial-gradient(circle, var(--accent-blue), transparent 70%)" }}
      />
      <div
        className="absolute top-20 right-0 w-[500px] h-[400px] rounded-full opacity-[0.08] blur-[100px] pointer-events-none"
          ...
          <div>
            ...
            <FadeIn delay={0.1}>
              <p className="mt-6 text-base sm:text-lg text-foreground/55 leading-relaxed max-w-lg">
                One platform that unifies your revenue stack — data, intelligence, and autonomous
                execution — into a single compounding growth engine. Built for B2B teams serious
                about scale.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.15}>
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <button
                  onClick={onAudit}
                  className="btn-primary w-full sm:w-auto justify-center px-7 py-3.5 text-sm"
                >
                  Get Your Free Blueprint <ArrowRight size={15} />
                </button>
                <a
                  href="#platform-layers"
                  className="btn-ghost w-full sm:w-auto justify-center px-7 py-3.5 text-sm"
                >
                  See How It Works
                </a>
              </div>
              <p className="mt-3 text-xs text-foreground/35">
                No pitch. No commitment. Just clarity on your GTM gaps.
              </p>
            </FadeIn>
              ...
              <div className="mt-8 flex flex-wrap gap-6 sm:gap-8 border-t border-border pt-7">
                {[
                  ...
                  <div key={s.label}>
                    ...
                    <div className="text-[11px] text-foreground/40 mt-0.5 uppercase tracking-widest">
                      {s.label}
                    </div>
                  </div>
                ))}
          ...
          <FadeIn delay={0.12} y={24}>
            ...
            <div className="sm:hidden grid grid-cols-2 gap-3">
              {[
                ...
                { val: "4", label: "Agents running", c: "var(--brand-charcoal)" },
                { val: "2m", label: "Last data sync", c: "var(--accent-blue)" },
              ].map((s) => (
                <div
                  key={s.label}
                  className="rounded-lg border border-border bg-white shadow-sm p-4"
                >
                  <div className="text-2xl font-black mb-1" style={{ color: s.c }}>
                    {s.val}
                  </div>
...
function TrustBar() {
  return (
    <div className="bg-secondary border-y border-border/50 py-5 px-4">
      <div className="container-x">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-5">
          <p className="text-[11px] font-bold tracking-[0.15em] uppercase text-muted-foreground shrink-0">
            Trusted by founders at
          </p>
          <div className="flex flex-wrap justify-center sm:justify-end gap-x-6 gap-y-2">
            {["Meridian SaaS", "Stackline", "Orbita Growth", "Hexade", "Forta Labs"].map((co) => (
              <span key={co} className="text-sm font-semibold text-muted-foreground">
                {co}
              </span>
            ))}
          </div>
          <div className="flex items-center gap-1.5 shrink-0">
            {[...Array(5)].map((_, i) => (
              <svg key={i} width="12" height="12" viewBox="0 0 12 12" fill="none">
                <path
                  d="M6 1l1.236 2.506L10 3.9l-2 1.95.472 2.748L6 7.25 3.528 8.598 4 5.85 2 3.9l2.764-.394L6 1z"
                  fill="#c5a059"
                />
              </svg>
            ))}
            <span className="text-[11px] text-muted-foreground ml-1">5.0 avg satisfaction</span>
          </div>
        </div>
      </div>
    </div>
...
function TickerBar() {
  ...
  return (
    <div className="bg-white border-b border-border/50 py-3.5 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
          <FadeIn>
            ...
            <p className="mt-6 text-base sm:text-lg text-foreground/60 leading-relaxed">
              The average B2B revenue team runs 12+ tools. None of them share intelligence. Your
              team becomes the middleware — manually copying data, chasing signals, and guessing at
              priority. That's not a tools problem. It's a systems problem.
            </p>
            <div className="mt-8 space-y-3.5">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  <div className="h-5 w-5 rounded-full bg-[var(--destructive)]/5 border border-[var(--destructive)]/15 flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div className="mt-8">
              <button
                onClick={onAudit}
                className="inline-flex items-center gap-2 text-sm font-semibold text-[var(--accent-blue)] hover:gap-3 transition-all"
              >
          ...
          <FadeIn delay={0.1}>
            <div className="relative rounded-lg border border-border bg-secondary/70 p-7 sm:p-8 overflow-hidden shadow-sm">
              <div className="absolute inset-0 dot-grid opacity-[0.05]" />
              <div className="relative">
                <div className="text-[10px] font-bold tracking-widest uppercase text-foreground/30 mb-5">
                  A typical B2B tech stack
                </div>
                <div className="grid grid-cols-3 gap-2.5">
                  {[
                    ...
                    <div
                      key={i}
                      className="px-3 py-2.5 rounded-lg border border-[var(--destructive)]/15 bg-white shadow-sm text-center"
                    >
                ...
                <div className="mt-4 flex items-center justify-center gap-3 py-3 rounded-lg border border-[var(--destructive)]/15 bg-[var(--destructive)]/5">
                  <X size={13} className="text-[var(--destructive)]/80" />
                  <span className="text-xs font-semibold text-[var(--destructive)]/70">
                    9 tools. Zero shared intelligence.
                  </span>
                </div>
                <div className="mt-4 p-3.5 rounded-lg border border-[var(--accent-green)]/30 bg-[var(--accent-green)]/5">
                  <div className="flex items-center gap-2.5 mb-2">
                    <div className="w-6 h-6 rounded-md bg-foreground flex items-center justify-center text-background text-[11px] font-black">
                      M
                    </div>
                    <span className="text-xs font-bold text-foreground">
                      Magnivo replaces this with one system
                    </span>
                  </div>
                  <div className="flex flex-wrap gap-1.5">
                    {["Data", "Intelligence", "Execution", "Attribution"].map((t) => (
                      <span
                        key={t}
                        className="text-[10px] bg-[var(--accent-green)]/15 text-[var(--accent-green)] font-semibold px-2 py-0.5 rounded-full"
                      >
                        {t}
                      </span>
                    ))}
...
const LAYERS = [
  {
    ...
    features: [
      "CRM sync & automated hygiene",
      "Buying intent signal ingestion",
      "Web visitor identification",
      "Contact & account enrichment",
      "Multi-source attribution",
      "Firmographic data layer",
    ],
    visual: (
      <div className="space-y-2.5">
        {[
          { src: "HubSpot CRM", pct: 100, c: "var(--accent-blue)" },
          { src: "6sense Intent", pct: 92, c: "var(--accent-green)" },
          { src: "Clearbit", pct: 88, c: "var(--accent-blue)" },
          { src: "Web Events", pct: 76, c: "var(--brand-charcoal)" },
        ].map((s) => (
  ...
  },
  {
    ...
    features: [
      "AI-powered account fit scoring",
      "Buying timing prediction",
    ...
    visual: (
      <div className="space-y-3">
        <div className="flex items-center justify-between mb-1">
          <span className="text-xs text-foreground/50">Acme Corp</span>
          <span className="text-xs font-black text-[var(--accent-green)]">Score 94 ↑</span>
        </div>
        <div className="p-3.5 rounded-lg border border-[var(--accent-green)]/25 bg-[var(--accent-green)]/6">
          <div className="text-[10px] text-[var(--accent-green)] font-bold uppercase tracking-wider mb-2">
            Next Best Action
          </div>
          <div className="text-sm text-foreground font-medium leading-snug">
            Trigger outbound sequence — pricing page visited 3× this week by VP Sales
          </div>
        </div>
        <div className="grid grid-cols-2 gap-2">
          {[
            { label: "Fit Score", val: "94" },
            { label: "Intent Level", val: "High" },
            { label: "Stage", val: "Evaluate" },
            { label: "Confidence", val: "97%" },
          ].map((m) => (
            <div key={m.label} className="bg-secondary border border-border/50 rounded-lg p-2.5">
              <div className="text-[10px] text-foreground/35 uppercase tracking-wider">
                {m.label}
              </div>
  ...
  },
  {
    ...
    features: [
      "Outbound email sequencing agents",
      "LinkedIn engagement automation",
      "SEO + AEO content agents",
      "Pipeline management agents",
      "Retention & lifecycle automation",
      "CRM data hygiene agents",
    ],
    visual: (
      <div className="space-y-2">
        {[
          { name: "Outbound Agent", status: "Sending", msgs: "14 sent today", active: true },
          { name: "LinkedIn Agent", status: "Engaging", msgs: "8 connections", active: true },
          { name: "SEO Agent", status: "Writing", msgs: "3 drafts ready", active: true },
          { name: "RevOps Agent", status: "Syncing", msgs: "CRM updated", active: true },
          { name: "Retention Agent", status: "Watching", msgs: "2 at-risk flagged", active: false },
        ].map((a) => (
          <div
            key={a.name}
          ...
          >
            <div className="flex items-center gap-2.5">
              <div
                className={`w-1.5 h-1.5 rounded-full ${a.active ? "bg-[var(--accent-green)] animate-pulse" : "bg-muted-foreground/30"}`}
              />
              <div>
            ...
            <span
              className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${a.active ? "bg-[var(--accent-green)]/10 text-[var(--accent-green)]" : "bg-muted text-muted-foreground"}`}
            >
              {a.status}
            </span>
          </div>
...
function LayerSection() {
  ...
  return (
    <section
      id="platform-layers"
      className="py-20 sm:py-24 md:py-32 bg-secondary border-b border-border"
    >
      <div className="container-x">
        <FadeIn>
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="mt-4 text-foreground/50 text-base sm:text-lg leading-relaxed">
              Most platforms give you one layer. Magnivo gives you all three — wired together,
            ...
            {LAYERS.map((l, i) => {
              ...
              return (
                <button
                  key={l.id}
                  onClick={() => setActive(i)}
                  className={`flex items-center gap-3 px-5 py-3 rounded-lg border text-sm font-semibold transition-all ${active === i ? "border-[var(--accent-blue)]/30 bg-white text-foreground shadow-sm" : "border-border bg-white/60 text-foreground/50 hover:text-foreground/70 hover:bg-white"}`}
                >
                  <LIcon size={16} style={{ color: active === i ? l.color : undefined }} />
                  <span className="text-[11px] font-black tracking-widest uppercase opacity-40 mr-1">
                    {l.num}
                  </span>
                  {l.label}
                </button>
        ...
        <FadeIn delay={0.05}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-lg border border-border bg-white overflow-hidden shadow-sm">
            <div className="p-7 sm:p-10 md:p-12">
              ...
              <p className="text-foreground/55 leading-relaxed mb-8 text-sm sm:text-base">
                {layer.body}
              </p>
            ...
            <div className="border-t lg:border-t-0 lg:border-l border-border p-7 sm:p-10 md:p-12 flex flex-col justify-center bg-secondary/60">
              <div className="text-[10px] font-bold tracking-widest uppercase text-foreground/30 mb-5">
                {layer.label} · Live View
              </div>
              {layer.visual}
            </div>
          </div>
...
const BENTO = [
  {
    ...
    desc: "A live command center. Know what's happening, what's at risk, and what to do next — for every account, in real-time.",
    visual: (
      <div className="mt-4 grid grid-cols-3 gap-2">
        {[
          ...
          <div
            key={m.l}
            className="bg-secondary border border-border/50 rounded-lg p-3 text-center"
          >
            <div className="text-lg font-black text-foreground">{m.v}</div>
            <div className="text-[10px] text-foreground/40 mt-0.5">{m.l}</div>
          </div>
        ))}
      </div>
    ),
  },
  {
    ...
    desc: "Get notified the moment a target account shows real purchase intent — before competitors act.",
    visual: (
      <div className="mt-4 space-y-2">
        {[
          { co: "Acme Corp", signal: "Pricing page · 4× visits" },
          { co: "TechFlow", signal: "Decision maker active" },
          { co: "Nordex Group", signal: "Competitor searched" },
        ].map((a) => (
          <div
            key={a.co}
            className="flex items-start gap-2.5 p-2.5 rounded-lg bg-secondary border border-border/50"
          >
            <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-gold)] mt-1.5 shrink-0 animate-pulse" />
            <div>
              <div className="text-xs font-bold text-foreground">{a.co}</div>
              <div className="text-[10px] text-foreground/50">{a.signal}</div>
            </div>
          </div>
        ))}
      </div>
  ...
  },
  {
    ...
    desc: "Agents keep your CRM clean, enriched, and accurate — without manual effort.",
    visual: (
      <div className="mt-4 space-y-2">
        {[
          { label: "Contacts enriched", val: "1,247" },
          { label: "Dupes removed", val: "89" },
          { label: "Stale records", val: "0" },
        ].map((r) => (
          <div
            key={r.label}
          ...
          >
            ...
            <span className="text-xs font-bold text-[var(--accent-green)]">{r.val}</span>
          </div>
        ))}
      </div>
    ),
  },
  {
    ...
    color: "var(--accent-blue)",
    label: "AI Agents",
    title: "Always-on Agent Fleet",
    desc: "Specialized agents executing outbound, content, RevOps, and retention — 24/7 without supervision.",
    visual: (
      <div className="mt-4 space-y-2">
        {["Outbound", "LinkedIn", "SEO", "RevOps"].map((a) => (
          <div key={a} className="flex items-center gap-2.5">
            <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-blue)] animate-pulse" />
            <span className="text-xs text-foreground/70 flex-1">{a} Agent</span>
            <span className="text-[10px] bg-[var(--accent-blue)]/10 text-[var(--accent-blue)] font-semibold px-2 py-0.5 rounded-full">
              Live
            </span>
          </div>
        ))}
  ...
  },
  {
    ...
    desc: "Connect every touchpoint to every outcome. Know exactly what's driving pipeline — and double down on what works.",
    visual: (
      <div className="mt-4">
        <div className="flex items-end gap-2 h-14">
          {[30, 45, 60, 52, 70, 85, 78, 92, 88, 100].map((h, i) => (
            <div
              key={i}
              className="flex-1 rounded-t"
              style={{
                height: `${h}%`,
                background: `color-mix(in oklab, var(--accent-green) ${50 + h / 3}%, var(--accent-blue) ${100 - h / 3}%)`,
                opacity: 0.55 + i * 0.04,
              }}
            />
          ))}
        </div>
        <div className="flex justify-between mt-2 text-[10px] text-foreground/30">
          <span>Jan</span>
          <span>Mar</span>
          <span>Jun</span>
          <span>Sep</span>
          ...
          {BENTO.map((cell, i) => {
            ...
            return (
              <FadeIn key={i} delay={i * 0.06} className={cell.span}>
                <div
                  className="premium-card p-6 sm:p-7 bg-card border-border/60 h-full flex flex-col group hover:shadow-lg transition-all duration-300"
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = `0 0 32px -8px color-mix(in oklab, ${cell.color} 30%, transparent)`;
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  <div
                    className="h-10 w-10 rounded-lg border border-border bg-secondary flex items-center justify-center mb-4"
...
const STEPS = [
  {
    ...
    title: "Capture",
    color: "var(--accent-blue)",
    desc: "Every signal unified into one enriched layer.",
    tags: ["CRM sync", "Intent", "Web"],
  },
  {
    n: "02",
    icon: Search,
    title: "Identify",
    color: "var(--accent-green)",
    desc: "AI scores accounts for fit, intent, and timing.",
    tags: ["ICP scoring", "Signals", "Mapping"],
  },
  {
    n: "03",
    icon: Zap,
    title: "Activate",
    color: "var(--accent-gold)",
    desc: "Autonomous agents launch coordinated outreach.",
    tags: ["Email", "LinkedIn", "Multi-ch"],
  },
  {
    n: "04",
    icon: Target,
    title: "Convert",
    color: "var(--accent-blue)",
    desc: "Accelerate pipeline and manage qualification.",
    tags: ["Deal scoring", "Meetings", "Pipeline"],
  },
  {
    n: "05",
    icon: RefreshCw,
    title: "Retain",
    color: "var(--accent-green)",
    desc: "Monitor health and automate lifecycle plays.",
    tags: ["Health score", "Expansion", "Churn ops"],
  },
] as const;

function PipelineSection() {
  return (
    <section className="py-20 sm:py-24 md:py-32 bg-secondary/60 border-b border-border">
      <div className="container-x">
        <FadeIn>
          <div className="text-center max-w-xl mx-auto mb-14">
            ...
            <p className="mt-5 text-foreground/55 text-base sm:text-lg leading-relaxed">
              A closed-loop engine. Every retained customer feeds the next acquisition cycle.
            </p>
          </div>
        </FadeIn>
        ...
        <div className="relative">
              ...
              return (
                <FadeIn key={i} delay={i * 0.08}>
                  <div className="flex flex-col items-center text-center">
                    <div
                      className="relative z-10 w-[52px] h-[52px] rounded-full border-2 bg-white shadow-sm flex items-center justify-center mb-4"
                      style={{ borderColor: step.color + "40" }}
                    >
                      <SIcon size={20} style={{ color: step.color }} />
                    </div>
                    <div className="text-[10px] font-black tracking-widest text-foreground/25 mb-2">
                      {step.n}
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-1.5">
                      {step.tags.map((t) => (
                        <span
                          key={t}
                          className="text-[10px] bg-white border border-border rounded-full px-2 py-0.5 text-foreground/50 font-medium"
                        >
                          {t}
                        </span>
                      ))}
          ...
          <FadeIn delay={0.45}>
            <div className="mt-10 rounded-lg border border-[var(--accent-blue)]/20 bg-[var(--accent-blue)]/5 p-6 sm:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div>
                <div className="label-eyebrow mb-2 text-[var(--accent-blue)]/60">
                  THE COMPOUNDING LOOP
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-foreground">
                  Step 05 feeds back into Step 01.
                </h3>
                <p className="text-foreground/55 mt-2 max-w-lg text-sm leading-relaxed">
                  Every retained customer becomes a new signal. Every closed deal teaches the
                  scoring model. Revenue becomes systematic, not linear.
                </p>
              </div>
...
const TESTIMONIALS = [
  {
    quote:
      "We replaced three vendors, cut tooling cost by 40%, and had our first AI-sourced meeting booked within 11 days. The system just works — and keeps getting smarter.",
    name: "James Whitfield",
    role: "CEO",
    company: "Meridian SaaS",
    initials: "JW",
    color: "var(--accent-blue)",
    metric: "$890K pipeline in 60 days",
  },
  {
    quote:
      "I've run RevOps at four companies. Magnivo is the first platform that actually connected our signals to our outreach without me building the middleware myself. It's what modern RevOps should look like.",
    name: "Sarah Chen",
    role: "VP RevOps",
    company: "Stackline",
    initials: "SC",
    color: "var(--accent-green)",
    metric: "4 tools replaced. One system.",
  },
  {
    quote:
      "Our CAC dropped 52% in Q1. Not because we changed our ICP — because the system finally knew which accounts to prioritise and when to hit them. We've never moved this fast.",
    name: "Marcus Okafor",
    role: "Founder & CEO",
    company: "Orbita Growth",
    initials: "MO",
    color: "var(--accent-gold)",
    metric: "52% CAC reduction, Q1",
  },
];
      ...
      <div className="container-x">
        <FadeIn>
          <div className="text-center max-w-xl mx-auto mb-14">
            ...
            <p className="mt-4 text-foreground/50 text-base sm:text-lg">
              Real results from B2B teams who made the switch.
            </p>
          </div>
        </FadeIn>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {TESTIMONIALS.map((t, i) => (
            <FadeIn key={i} delay={i * 0.1}>
              <div className="rounded-lg border border-border bg-secondary/60 p-7 flex flex-col h-full hover:border-[var(--accent-blue)]/30 hover:shadow-md transition-all">
                ...
                <p className="text-sm sm:text-base text-foreground/70 leading-relaxed flex-1 mb-7 italic">
                  "{t.quote}"
                </p>
                <div className="flex items-center gap-3 mb-5 pt-5 border-t border-border">
                  <div
                    ...
                    style={{ background: `color-mix(in oklab, ${t.color} 80%, transparent)` }}
                  >
                    {t.initials}
                  </div>
                  <div>
  ...
  const stats = [
    {
      ...
      decimals: 1,
      label: "Pipeline Lift",
      desc: "Avg lift vs prior manual outreach motion",
      c: "var(--accent-blue)",
    },
    {
      prefix: "",
      ...
      decimals: 0,
      label: "CAC Reduction",
      desc: "Lower cost per acquired customer in 90 days",
      c: "var(--accent-green)",
    },
    {
      prefix: "",
      ...
      decimals: 0,
      label: "Time to Live",
      desc: "From kick-off to fully operational system",
      c: "var(--accent-gold)",
    },
    {
      prefix: "$",
      ...
      suffix: "M",
      decimals: 1,
      label: "Avg Pipeline Added",
      desc: "Revenue influenced in the first 6 months",
      c: "var(--accent-blue)",
    },
  ];

  return (
    <section className="py-20 sm:py-24 md:py-32 bg-secondary border-b border-border">
      <div className="container-x">
        <FadeIn>
          <div className="text-center max-w-xl mx-auto mb-14">
            ...
            <p className="mt-5 text-foreground/50 text-base sm:text-lg leading-relaxed">
              We don't report on emails sent or impressions served. We report on pipeline created,
              revenue influenced, and CAC reduced.
            </p>
          </div>
        </FadeIn>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {stats.map((s, i) => (
            <FadeIn key={i} delay={i * 0.08}>
              <div className="rounded-lg border border-border bg-white p-6 sm:p-7 text-center hover:shadow-md transition-all">
                <div
                ...
                <div className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-foreground/35 mb-2">
                  {s.label}
                </div>
                <div className="text-[11px] text-foreground/40 leading-relaxed hidden sm:block">
                  {s.desc}
                </div>
              </div>
            </FadeIn>
        ...
        <FadeIn delay={0.35}>
          <div className="text-center">
            <button
              onClick={onAudit}
              className="btn-primary px-8 py-3.5 text-sm sm:text-base w-full sm:w-auto justify-center"
            >
              See What's Possible for Your Business <ArrowRight size={15} />
            </button>
            <p className="mt-3 text-xs text-foreground/35 uppercase tracking-widest">
              No pitch · 30-min audit · Clear blueprint
            </p>
          </div>
        </FadeIn>
      </div>
        ...
        <FadeIn>
          <div className="max-w-xl mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tighter">
              From manual chaos
              <br />
              <span className="text-gradient">to $1.4M pipeline.</span>
            </h2>
            <p className="mt-5 text-foreground/60 text-base sm:text-lg leading-relaxed">
              A Series A B2B SaaS ($2M ARR) replaced their manual SDR-led outbound with Magnivo.
        ...
        <FadeIn delay={0.1}>
          <div className="rounded-lg border border-border overflow-hidden shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-2">
              {/* Before */}
              <div className="p-7 sm:p-10 bg-[var(--destructive)]/5 border-b md:border-b-0 md:border-r border-border">
                <div className="text-[10px] font-bold tracking-widest uppercase text-[var(--destructive)]/70 mb-6">
                  Before Magnivo
                </div>
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={r.label}
                      className="flex items-center justify-between py-2.5 border-b border-[var(--destructive)]/15/70 last:border-0"
                    >
                      <span className="text-sm text-foreground/60">{r.label}</span>
                      <span className="text-sm font-semibold text-[var(--destructive)]/80 flex items-center gap-1.5">
                        <X size={13} />
                        {r.val}
                      </span>
                    </div>
              ...
              <div className="p-7 sm:p-10 bg-[var(--accent-green)]/5">
                <div className="text-[10px] font-bold tracking-widest uppercase text-[var(--accent-green)] mb-6">
                  After Magnivo (90 days)
                </div>
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={r.label}
                      className="flex items-center justify-between py-2.5 border-b border-[var(--accent-green)]/10 last:border-0"
                    >
                      <span className="text-sm text-foreground/60">{r.label}</span>
                      <span className="text-sm font-semibold text-[var(--accent-green)] flex items-center gap-1.5">
            ...
            {/* Timeline strip */}
            <div className="border-t border-border bg-secondary/60 px-7 sm:px-10 py-5">
              <div className="flex items-center gap-0 overflow-x-auto pb-1">
                {[
                  ...
                  <div key={i} className="flex items-center shrink-0">
                    ...
                    {i < arr.length - 1 && (
                      <div className="w-8 sm:w-12 h-px bg-border mx-1 shrink-0" />
                    )}
                  </div>
                ))}
              </div>
...
const INTEGRATIONS = [
  ...
  { name: "Clearbit", cat: "Data" },
  { name: "6sense", cat: "Intent" },
  { name: "Bombora", cat: "Intent" },
  { name: "Outreach", cat: "Sequences" },
  { name: "Salesloft", cat: "Sequences" },
  { name: "LinkedIn", cat: "Social" },
  { name: "Google Ads", cat: "Paid" },
  { name: "Meta Ads", cat: "Paid" },
  { name: "Slack", cat: "Alerts" },
  { name: "Webflow", cat: "Web" },
  { name: "Stripe", cat: "Revenue" },
      ...
      <div className="container-x">
        <FadeIn>
          <div className="text-center mb-10">
            ...
            <p className="mt-4 text-foreground/55 max-w-lg mx-auto text-sm sm:text-base">
              Native integrations across CRM, intent, sequencing, paid, and analytics — all unified
        ...
        <FadeIn delay={0.1}>
          <div className="flex flex-wrap justify-center gap-2 sm:gap-2.5 max-w-3xl mx-auto">
            {INTEGRATIONS.map((t, i) => (
              <div
                key={i}
                className="flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-border bg-secondary text-xs sm:text-sm font-medium text-foreground/65 hover:border-[var(--accent-blue)]/35 hover:bg-[var(--accent-blue)]/5 hover:text-foreground transition-all cursor-default"
              >
                <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-blue)]/50 shrink-0" />
                {t.name}
                <span className="text-[10px] text-foreground/30 font-normal hidden sm:inline">
                  {t.cat}
                </span>
              </div>
            ))}
      ...
      <div className="container-x">
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-foreground/55 max-w-md mx-auto text-base sm:text-lg">
              Point solutions create complexity. Magnivo creates clarity.
            </p>
          </div>
        </FadeIn>
        <FadeIn delay={0.1}>
            ...
            <table className="w-full text-left min-w-[480px]">
              <thead>
                <tr className="border-b border-border bg-secondary">
                  <th className="px-5 sm:px-7 py-4 text-sm font-bold text-foreground/40 w-1/3">
                    Dimension
                  </th>
                  <th className="px-5 sm:px-7 py-4 text-sm font-bold text-foreground/35">
                    Point Tools
                  </th>
                  <th className="px-5 sm:px-7 py-4 text-sm font-black text-[var(--accent-blue)] bg-[var(--accent-blue)]/5">
                    Magnivo OS
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border">
                {COMPARE_ROWS.map((r, i) => (
                  <tr key={i} className="hover:bg-secondary/50 transition-colors">
                    <td className="px-5 sm:px-7 py-3.5 text-sm font-semibold text-foreground/60">
                      {r.dim}
                    </td>
...
const PERSONAS = [
  {
    ...
    title: "SaaS Founders",
    role: "Founder / CEO",
    desc: "Post-PMF. GTM is still manual and dependent on one or two people.",
    outcome: "Replace manual GTM with a system that scales without headcount",
  },
  {
    icon: BarChart2,
    title: "RevOps Leaders",
    role: "VP RevOps",
    desc: "The data exists. What's missing is the intelligence layer that acts on it.",
    outcome: "Add AI intelligence on top of your existing sales motion",
  },
  {
    icon: Briefcase,
    title: "Service Firms",
    role: "Managing Partner",
    desc: "Pipeline depends on referrals. Outbound is inconsistent. Inbound is near zero.",
  ...
  },
  {
    ...
    role: "CEO / CRO",
    desc: "You just raised and need pipeline fast. Hiring a VP Sales takes months.",
  ...
  },
  {
    ...
    role: "VP Sales",
    desc: "You have quota and a team. What's missing is the intelligence layer before reps touch accounts.",
    outcome: "Give reps an AI system that fills top of funnel at scale",
  },
  {
    icon: Globe,
    title: "B2B Marketplaces",
    role: "Head of Growth",
    desc: "Two-sided markets need coordinated GTM. Standard tools weren't built for this.",
    outcome: "Orchestrate multi-sided GTM with one unified system",
  },
] as const;
      ...
      <div className="container-x">
        <FadeIn>
          <div className="max-w-xl mb-12">
            ...
            <p className="mt-5 text-foreground/50 text-base sm:text-lg leading-relaxed">
              B2B companies at $500K–$5M ARR with a product that works, a market that exists, and a
              GTM motion that isn't keeping up.
            </p>
          </div>
        </FadeIn>
          ...
          {PERSONAS.map((p, i) => {
            ...
            return (
              <FadeIn key={i} delay={i * 0.06}>
                <div className="p-5 sm:p-6 rounded-lg border border-border bg-white flex flex-col h-full hover:border-[var(--accent-blue)]/30 hover:shadow-md transition-all">
                  ...
                  <span className="inline-block text-[10px] font-bold tracking-widest uppercase text-foreground/35 bg-secondary border border-border px-2.5 py-1 rounded-full mb-4 w-fit">
                    {p.role}
                  </span>
        ...
        <FadeIn delay={0.4}>
          <div className="mt-8 max-w-2xl mx-auto text-center bg-secondary border border-border rounded-lg py-5 px-5 sm:px-6">
            <div className="text-[10px] font-bold tracking-widest uppercase text-foreground/30 mb-2">
              NOT A FIT IF...
            </div>
            <p className="text-sm text-foreground/45 leading-relaxed">
              You're pre-revenue, without a defined product, or looking for a one-time campaign.
              Magnivo is a system — built to compound growth, not run a sprint.
            </p>
          </div>
        </FadeIn>
      </div>
      ...
      <div className="container-x max-w-3xl">
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-foreground/55 text-base sm:text-lg">
          ...
          <div className="space-y-3">
            {FAQS.map((faq, i) => {
              ...
              return (
                <div
                  key={i}
                  className="rounded-lg border border-border bg-white overflow-hidden hover:border-[var(--accent-blue)]/25 transition-colors"
                >
                  <button
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="px-5 sm:px-6 pb-5 sm:pb-6 text-sm text-foreground/55 leading-relaxed">
                        {faq.a}
                      </p>
                    </div>
                  </div>
...
function CtaSection({ onAudit, ctaRef }: { onAudit: () => void; ctaRef: React.Ref<HTMLElement> }) {
  return (
    <section ref={ctaRef} className="relative bg-white overflow-hidden py-20 sm:py-28 md:py-36">
      ...
      <div
        className="absolute -top-32 left-1/4 w-[800px] h-[600px] rounded-full opacity-[0.10] blur-[140px] pointer-events-none"
        style={{ background: "radial-gradient(circle, var(--accent-blue), transparent 70%)" }}
      />
      <div
        className="absolute bottom-0 right-1/4 w-[600px] h-[500px] rounded-full opacity-[0.07] blur-[120px] pointer-events-none"
        style={{ background: "radial-gradient(circle, var(--accent-green), transparent 70%)" }}
      />
      ...
      <div className="container-x relative z-10 text-center">
        <FadeIn>
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-[var(--accent-blue)]/25 bg-[var(--accent-blue)]/8 px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase text-[var(--accent-blue)] mb-7">
            <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-blue)] animate-pulse" />⚡ 3
            founding client slots available this quarter
          </div>
          ...
          <p className="text-base sm:text-lg md:text-xl text-foreground/50 max-w-lg mx-auto mb-9 leading-relaxed px-2 sm:px-0">
            One conversation. We map your revenue system, identify the gaps, and show you exactly
            what Magnivo would build — before you commit to anything.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-5 mb-8">
            {[
              ...
              <span
                key={i}
                className="inline-flex items-center gap-1.5 text-xs text-foreground/40 font-medium"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center px-4 sm:px-0">
            <button
              onClick={onAudit}
              className="btn-primary px-8 py-4 text-base sm:text-lg w-full sm:w-auto justify-center"
            >
          ...
          <div className="mt-10 pt-8 border-t border-border flex flex-wrap justify-center gap-6">
            {[
              ...
              <div key={s.label} className="text-center">
                ...
                <div className="text-[11px] text-foreground/35 uppercase tracking-widest">
                  {s.label}
                </div>
              </div>
            ))}
