...
function HomePage() {
  ...
  return (
    <SiteLayout>
        ...
        <div className="container-x relative w-full">
          <FadeIn>
            ...
            <p className="mt-5 sm:mt-7 md:mt-8 text-center text-base sm:text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto leading-relaxed px-1 sm:px-2 font-medium">
              Magnivo helps B2B founders turn scattered tools, data, and manual outreach into one AI-powered GTM engine for pipeline, conversion, and retention.
            </p>

            <div className="mt-7 sm:mt-9 md:mt-10 flex justify-center flex-wrap gap-3 sm:gap-4 px-1 sm:px-2">
              <button onClick={() => setDemoOpen(true)} className="btn-primary w-full sm:w-auto justify-center text-base sm:text-lg min-h-12 sm:h-14 px-5 sm:px-8 bg-[var(--accent-blue)] text-white hover:bg-[var(--accent-blue)]/90 border-transparent shadow-[0_0_30px_-5px_color-mix(in_oklab,var(--accent-blue)_50%,transparent)]" data-cursor-text="Audit">
                Book Free GTM Audit <ArrowRight size={16} />
              </button>
              <a href="#ten-day-plan" className="btn-ghost w-full sm:w-auto justify-center text-base sm:text-lg min-h-12 sm:h-14 px-5 sm:px-8 border border-border/50 bg-card/30" data-cursor-text="Plan">
                See the 10-Day Plan
              </a>
            </div>

            <div className="mt-7 flex flex-wrap items-center justify-center gap-3 text-xs sm:text-sm text-muted-foreground font-medium">
              {["No pitch", "30-minute audit", "Clear GTM blueprint", "Limited founding-client slots"].map((item) => (
                <span key={item} className="inline-flex items-center gap-2 rounded-full border border-border bg-card/40 px-3 py-1.5">
      ...
      {/* CREDIBILITY BAR */}
      <section className="border-y border-border py-5 overflow-hidden relative">
        ...
        <div className="flex w-full overflow-hidden marquee-container">
          <div className="marquee flex gap-6 md:gap-12 whitespace-nowrap items-center px-4 w-max">
            {[
              ...
              "Strategic AI Advisory", "Growth Intelligence",
              "GTM Orchestration", "AI Agents", "Pipeline Intelligence",
              "Autonomous Outreach", "Account-Based Marketing", "AEO + GEO Optimisation",
              "Revenue Attribution", "Demand Generation", "AI Agent Orchestration",
              "Lifecycle & Retention", "GTM OS", "Revenue Intelligence",
      ...
      <section className="container-x py-12 sm:py-16 md:py-24 relative">
        ...
        <div className="mt-10 md:mt-14 grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch lg:items-center">
          ...
          <FadeIn delay={0.1}>
            <div className="premium-card p-5 sm:p-7 md:p-9 h-full border-[var(--accent-green)]/30 shadow-[0_0_40px_-10px_color-mix(in_oklab,var(--accent-green)_20%,transparent)] relative z-10 scale-100 lg:scale-105 bg-card">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                <div className="p-6 md:p-9 border-b md:border-b-0 md:border-r border-border/50">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="px-3 py-1 rounded-full border border-[var(--accent-green)]/30 bg-[var(--accent-green)]/10 text-xs font-bold tracking-wider text-[var(--accent-green)]">EXECUTION</span>
                  </div>
      ...
      <section id="how-it-works" className="py-12 sm:py-16 md:py-24">
            ...
            return (
              <div key={i} className="w-full flex flex-col items-center">
                <FadeIn delay={i * 0.1} className="w-full">
                  <div
                    className="w-full rounded-2xl overflow-hidden transition-all duration-300 group premium-card"
                    onMouseEnter={(e) => e.currentTarget.style.boxShadow = `0 0 24px -6px ${stage.color}40`}
                  ...
                  >
                    ...
                    <div className="w-full md:w-[40%] flex flex-col items-start">
                      <div className="flex items-center gap-3 mb-6">
                        <span className="text-2xl font-black text-foreground/10">{stage.stageNum}</span>
                      ...
                      <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-5 bg-secondary" style={{ color: stage.color }}>
                        <Icon size={24} />
                      </div>
                        ...
                        <ul key={colIdx} className="space-y-2.5">
                          {col.map((item, itemIdx) => (
                            <li key={itemIdx} className="flex items-start gap-2">
                              ...
                              <span className="text-sm text-foreground/70 leading-tight">{item}</span>
                            </li>
                          ))}
                        </ul>
                      ))}
        ...
        <FadeIn delay={0.5}>
          <div className="mt-12 text-center max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-foreground mb-2">Platform. Execution. Strategy.</h3>
            <p className="text-base text-muted-foreground mb-8">
              Three layers running together. That's when revenue stops being linear and starts being exponential.
            </p>
            <button onClick={() => setDemoOpen(true)} className="btn-primary inline-flex items-center justify-center bg-[var(--accent-blue)] text-white hover:bg-[var(--accent-blue)]/90 h-14 px-8 text-lg border-transparent shadow-[0_0_30px_-5px_color-mix(in_oklab,var(--accent-blue)_50%,transparent)]">
      ...
      <section className="py-12 sm:py-16 md:py-24">
        ...
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-foreground">
              Built for the teams <span className="text-[var(--accent-blue)] block mt-1">driving modern B2B revenue.</span>
            </h2>
            <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
          ...
          {[
            ...
            return (
              <FadeIn key={i} delay={i * 0.05}>
                <div className="group h-full bg-card border border-border hover:border-border/60 hover:bg-secondary/20 transition-all duration-300 rounded-xl p-5 flex flex-col premium-card">
                  <div className="w-9 h-9 rounded-lg flex items-center justify-center mb-4 text-[var(--accent-blue)]/80 bg-[var(--accent-blue)]/10">
                    <Icon size={18} />
                  </div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed flex-1 mb-5">{card.body}</p>
                  <div className="text-sm text-[var(--accent-blue)] font-bold leading-snug">
                    → {card.outcome}
                  </div>
                </div>
              </FadeIn>
        ...
        {/* NOT A FIT qualifier */}
        <FadeIn delay={0.3}>
          <div className="mt-8 max-w-3xl mx-auto bg-secondary border border-border rounded-xl py-5 px-5 sm:px-8 text-center">
            <div className="text-[10px] font-bold tracking-[0.2em] uppercase text-muted-foreground/40 mb-3">NOT A FIT IF...</div>
            <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {[
            ...
            <FadeIn key={i} delay={i * 0.1}>
              <div className="premium-card p-6 md:p-8 h-full border-t-[3px] border-t-transparent hover:border-t-[var(--accent-blue)] transition-all flex flex-col justify-center text-center">
          ...
          <div key={it.q} className="premium-card overflow-hidden bg-card/40 border-border/50">
            ...
            >
              <div className="overflow-hidden">
                <p className="px-5 md:px-6 pb-5 md:pb-6 text-base text-muted-foreground leading-relaxed">{it.a}</p>
              </div>
            </div>
          </div>
        );
