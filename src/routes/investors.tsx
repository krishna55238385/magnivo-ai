  ...
  head: () => ({
    meta: [
      { title: "Investors — Magnivo.ai" },
      {
        name: "description",
        content:
          "Magnivo.ai is building the AI operating system for modern GTM. Market opportunity, traction, and vision for partners and investors.",
      },
      { property: "og:title", content: "Building the AI Operating System for Modern GTM" },
      {
        property: "og:description",
        content: "Investor brief: market, platform, traction, and vision.",
      },
      ...
      <section className="container-x py-20">
        <FadeIn>
          ...
          <h2 className="mt-3 text-3xl md:text-4xl font-bold tracking-tight max-w-3xl">
            A category-defining wedge into a $200B market.
          </h2>
        </FadeIn>
      ...
      <section className="container-x py-12">
        <FadeIn>
          <div className="surface-card p-10">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-bold tracking-tight max-w-3xl">
              A unified intelligence layer is a moat point-tools can't reach.
            </h2>
            <p className="mt-5 text-muted-foreground max-w-3xl">
              Every customer engagement compounds shared data, agents, and orchestration logic —
              improving every product simultaneously. Competitors must rebuild the stack to catch
              up.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <div className="surface-card p-8 h-full">
            ...
            <p className="mt-4 text-muted-foreground">
              Veterans from leading SaaS, AI, and enterprise GTM companies — combining deep AI
              research with hands-on revenue operating experience.
            </p>
          </div>
        </FadeIn>
        <FadeIn delay={0.05}>
          <div className="surface-card p-8 h-full">
            ...
            <p className="mt-4 text-muted-foreground">
              Within five years, no high-growth company will run revenue without an AI orchestration
              layer. Magnivo is building it.
            </p>
          </div>
        </FadeIn>
      </section>
        ...
        >
          <div className="surface-card p-7 max-w-md w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Drop your email and we'll send the latest investor brief within 24 hours.
            </p>
            <form
            ...
            >
              <input
                ...
                className="w-full px-4 py-2.5 rounded-md bg-background border border-border focus:outline-none focus:border-[var(--accent-blue)]"
              />
              <input
                required
                type="email"
